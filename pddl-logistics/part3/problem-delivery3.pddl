(define (problem example1)
  ...
  (:init
   ...
   (vehicle truck1) (vehicle truck2) (vehicle Scooty-Puff)
   (truck truck1) (truck truck2) (moped Scooty-Puff)
  ...
  ;; The pre-defined goal is to deliver packet1 to office2 (i.e. that 'packet1' is 'at' 'office2')
